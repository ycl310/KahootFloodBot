...
First, make sure you change the game pin in the code that matches the game pin in the kahoot game of your desire
Run in the terminal :
```bash
python main.py
```
...
One thing to note is that you can change the amount of bots that joins the Kahoot by making changes to the code
